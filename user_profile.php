...
<body onload="openTab(event, 'Profile information')">
    ...
    <nav>
        <label class="logo">CineBase-INF-3741</label>
        ...
        <div class="nav-options">
            ...
            <li>
                <form action="search_movie.php" method="post">
                    ...
                    <button type="submit">PELICULA</button>
                </form>
            </li>
    ...
    <main>
        ...
        <h1>Tu perfil, <?php echo $name ?>!</h1>
        <h2>@<?php echo $username ?></h2>

        <div class="tab">
            <button class="tablinks" onclick="openTab(event, 'Profile information')">
Información del perfil</button>
            <button class="tablinks" onclick="openTab(event, 'Favorites')">Favoritos</button>
        </div>
