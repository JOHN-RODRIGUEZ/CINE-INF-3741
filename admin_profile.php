...
<body onload="openTab(event, 'management-options')">
    ...
    <nav>
        ...
        <div class="nav-options">
            ...
            <li><a href="logout.php">CERRRAR SECCION</a></li>
        </div>
    ...
    <main>
        ...
        <div class="tab">
            <button class="tablinks" onclick="openTab(event, 'management-options')">
Opciones de gestión</button>
            <button class="tablinks" onclick="openTab(event, 'settings')">Configuración de la sesión</button>
        </div>
        ...
        <div id="management-options" class="tabcontent">
            ...
            <div class="container">
                <a href="manage_users.php" class="admin-button" id="manage">Administrar usuarios</a>
            </div>

            <div class="container">
                <a href="add_movie.php" class="admin-button" id="add">Añadir pelicula</a>
            </div>
            ...
            <div class="container">
                <form action="search_movie.php" method="post">
                    ...
                    <button class="admin-button" id="hidden" type="submit">Películas ocultas</button>
                </form>
            </div>
            <br>
        ...
        <div id="settings" class="tabcontent">
            ...
            <button class="edit-button" type="submit" onclick="window.location='edit_admin.php';">Cambia la contraseña</button>
        </div>
